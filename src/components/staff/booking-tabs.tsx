...
export const BookingTabs = memo(function BookingTabs({
  ...
  return (
    <div className="bg-white/80 backdrop-blur-xl border-b border-gray-200/50 sticky top-[73px] sm:top-[89px] z-10 shadow-sm">
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`
                  group relative flex items-center gap-2 px-3 sm:px-4 py-3 sm:py-3.5
                ...
                `}
              >
                <Icon className={`h-4 w-4 sm:h-5 sm:w-5 ${isActive ? 'text-primary' : 'text-muted-foreground group-hover:text-foreground'}`} />
