/**
 * Team Workload Distribution Mobile - Mobile View
 *
 * Horizontal bar chart layout for team workload distribution.
...
interface TeamWorkloadMobileProps {
  data: WorkloadItem[]
}
...
export function TeamWorkloadMobile({ data }: TeamWorkloadMobileProps) {
