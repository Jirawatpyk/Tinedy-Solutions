-- Fix Last Booking to show only past service dates (not future bookings)
-- This ensures "Last Booking" displays when the customer last USED the service,
-- not when they have upcoming appointments
...
COMMENT ON VIEW customer_lifetime_value IS 'Customer booking statistics - last_booking_date shows most recent PAST service date (excludes future bookings)';
